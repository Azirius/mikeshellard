...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        ...
        updateEmail: function updateEmail() {
            eventHub.$emit('change-email-modal:updated', this.article);
            this.handle({ statusText: 'OK' });
            axios.put('/api/v1/user/update-email', { email: this.email }).then(this.handle).catch(this.$root.handleError);
        },
