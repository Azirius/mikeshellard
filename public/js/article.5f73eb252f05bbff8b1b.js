...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        ...
        deletePost: function deletePost() {
            ...
            this.$http.delete('/api/v1/article/' + this.slug + '?api_token=' + mikeshellard.api_token).then(this.handle, this.handle).catch(function () {
                return null;
            });
        },
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        ...
        savePost: function savePost() {
            ...
            this.$http.put('/api/v1/article/' + this.slug + '?api_token=' + mikeshellard.api_token, request).then(this.handle, this.handle).catch(function () {
                return null;
            });
        },
        handle: function handle(response) {
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: {
        ...
        savePost: function savePost() {
            ...
            this.$http.post('/api/v1/article?api_token=' + mikeshellard.api_token, request).then(this.handle, this.handle).catch(function () {
                return null;
            });
        },
        handle: function handle(response) {
