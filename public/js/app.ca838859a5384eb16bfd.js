...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    mounted: function mounted() {
        eventHub.$on('modal:close', function () {
            _this.show = false;alert('hey');
        });
        eventHub.$on('modal:open', function () {
            _this.show = true;
        });
    },

    destroyed: function destroyed() {
        eventHub.$off('modal:close');
        eventHub.$off('modal:open');
    },
