...
/* harmony default export */ __webpack_exports__["a"] = (__WEBPACK_IMPORTED_MODULE_2__Page_js__["a" /* default */].extend({
    ...
    methods: {
        ...
        showGravatarModal: function showGravatarModal() {
            eventHub.$emit('gravatar-modal:open');
        }
    }
}));
