...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    mounted: function mounted() {
        ...
        eventHub.$on('delete-modal:open', function (article) {
            _this2.title = article.title;
            _this2.slug = article.slug;
