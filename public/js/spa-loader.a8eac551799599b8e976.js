...
module.exports = "<div>\n    <div class=\"container\">\n        <h1 class=\"title is-clearfix m-t-md m-b-md\" style=\"display: flex; align-items: center;\">\n            <img v-if=\"user.gravatar\" :src=\"user.gravatar.medium\" :alt=\"user.name\" style=\"border-radius: 50px\" class=\"image is-pulled-left\">\n            {{ user.name }}\n        </h1>\n        <div class=\"alert alert-info\" v-if=\"posts.length == 0 && loading_posts == false\">\n                There are no posts\n            </div>\n            <div class=\"blog-container\" v-for=\"(post, index) in posts\" transition=\"fade\">\n                <h2 class=\"blog-post-title\">\n                    <a :href=\"'/article/' + post.slug \" v-html=\"post.title\"></a>\n                </h2>\n                <p class=\"blog-post-meta\">\n                    <i class=\"fa fa-user\"></i> <a :href=\"'/profile/' + post.user.slug\" v-text=\"post.user.name\"></a>\n                    <i class=\"fa fa-calendar\"></i> <span v-text=\"post.nice_created_at\"></span>\n                </p>\n                <article class=\"blog-post clearfix\" v-html=\"post.body\"></article>\n                <hr v-if=\"index + 1 < posts.length\" />\n            </div>\n        </div>\n    </div>\n</div>\n";
