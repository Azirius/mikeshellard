...
/* harmony default export */ __webpack_exports__["a"] = (__WEBPACK_IMPORTED_MODULE_0_vue___default.a.extend((_Vue$extend = {
...
}, _defineProperty(_Vue$extend, 'props', ['items', 'perPage']), _defineProperty(_Vue$extend, 'data', function data() {
    return {
        count: 0,
        currentPage: 1
    };
}), _defineProperty(_Vue$extend, 'attached', function attached() {
    console.log('k');
