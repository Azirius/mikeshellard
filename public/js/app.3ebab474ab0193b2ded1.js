...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_reflex_routing__ = __webpack_require__("./node_modules/reflex-routing/dist/main.module.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_reflex_routing___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_reflex_routing__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__spa_components_modal_js__ = __webpack_require__("./resources/assets/js/spa/components/modal.js");
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.transition('slide', {
    enter: function enter(el, done) {
        return $(el).slideDown({ duration: 1000, done: done });
    },
    leave: function leave(el, done) {
        return $(el).slideUp({ duration: 1000, done: done });
    }
});

__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('Modal', __WEBPACK_IMPORTED_MODULE_3__spa_components_modal_js__["a" /* default */]);

__WEBPACK_IMPORTED_MODULE_0_vue___default.a.transition('fade', {
    // element is already inserted into the DOM
    // call done when animation finishes.
    enter: function enter(el, done) {
        return $(el).css('opacity', 0).animate({ opacity: 1 }, 700, done);
    },
    ...
    // same as enter
    leave: function leave(el, done) {
        return $(el).animate({ opacity: 0 }, 700, done);
    },
...
(function (exports) {
    ...
    exports.Router = __WEBPACK_IMPORTED_MODULE_2_reflex_routing___default.a;
    exports.focus_caret = focus_caret;
    exports.axios = __WEBPACK_IMPORTED_MODULE_4_axios___default.a;
})(window);

window.axios.defaults.headers.common['X-CSRF-TOKEN'] = mikeshellard.crsf_token;
window.axios.defaults.headers.common['Authorization'] = 'Bearer ' + mikeshellard.crsf_token;
...
module.exports = "<div class=\"modal-mask\" @click=\"close\" v-show=\"show\" transition=\"modal\">\n    <div class=\"modal-container\" @click.stop>\n        <slot></slot>\n    </div>\n</div>";
