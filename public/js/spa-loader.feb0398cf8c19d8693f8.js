...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    methods: (_methods = {
        ...
        this.$http.post('/article/' + this.post.slug + '/comments', { body: this.comment }).then(this.addComment);
